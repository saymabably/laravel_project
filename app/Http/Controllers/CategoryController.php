...
//         return 'Category info save successfully';
        ...
        DB::table('sa_la__categories')->insert([
	...
	public function manageCategory() {
        $categories =Sa_la_Category::all();
        return view('admin.category.manageCategory', ['categories' => $categories]);
    }

    public function editCategory($id) {
        $categoryById = Sa_la_Category::where('id', $id)->first();
        return view('admin.category.editCategory', ['categoryById' => $categoryById]);
    }

    public function updateCategory(Request $request) {
        //dd( $request->all() );
        $category = Sa_la_Category::find($request->categoryId);
        $category->categoryName = $request->categoryName;
        $category->categoryDescription = $request->categoryDescription;
        $category->publicationStatus = $request->publicationStatus;
        $category->save();
    ...
    public function deleteCategory($id) {
        $category = Sa_la_Category::find($id);
        $category->delete();
